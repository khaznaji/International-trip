...
public class ReservationManipuler extends Form {
    ...
    public ReservationManipuler(Form previous) {
        super(ReservationAffiche.currentReservation == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentReservation = ReservationAffiche.currentReservation;
    ...
    private void showBackAndRefresh() {
        ((ReservationAffiche) previous).refresh();
        previous.showBack();
    }
