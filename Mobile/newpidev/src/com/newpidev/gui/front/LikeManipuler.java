...
public class LikeManipuler extends Form {
    ...
    public LikeManipuler(Form previous) {
        super(LikeAffiche.currentLike == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentLike = LikeAffiche.currentLike;
