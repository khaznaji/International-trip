...
public abstract class SideMenuBaseFormBack extends Form {
    ...
    public void setupSideMenu(Resources theme) {
        ...
        getToolbar().addMaterialCommandToSideMenu("  Users", FontImage.MATERIAL_HOUSE, e -> new UserAffiche(this).show());
        ...
        getToolbar().addMaterialCommandToSideMenu("  Chauffeurs", FontImage.MATERIAL_PERSON, e -> new ChaffeurAffiche(this).show());
