...
public class TypeManipuler extends Form {
    ...
    public TypeManipuler(Form previous) {
        super(TypeAffiche.currentTypes == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentTypes = TypeAffiche.currentTypes;
