...
public class LocationManipuler extends Form {
    ...
    public LocationManipuler(Form previous) {
        super(LocationAffiche.currentLocationc == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentLocationc = LocationAffiche.currentLocationc;
    ...
    private void showBackAndRefresh() {
        ((LocationAffiche) previous).refresh();
        previous.showBack();
    }
