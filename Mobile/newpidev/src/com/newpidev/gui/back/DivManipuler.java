...
public class DivManipuler extends Form {
    ...
    public DivManipuler(Form previous) {
        super(DivAffiche.currentDiv == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentDiv = DivAffiche.currentDiv;
