...
public class HebergementManipuler extends Form {
    ...
    public HebergementManipuler(Form previous) {
        super(HebergementAffiche.currentHebergement == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentHebergement = HebergementAffiche.currentHebergement;
    ...
    private void showBackAndRefresh() {
        ((HebergementAffiche) previous).refresh();
        previous.showBack();
    }
