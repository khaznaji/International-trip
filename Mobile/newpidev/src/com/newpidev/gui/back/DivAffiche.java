...
import com.newpidev.gui.front.LikeManipuler;
import com.newpidev.services.DivService;

import java.util.ArrayList;

public class DivAffiche extends Form {

    public static Div currentDiv = null;
        public static Div currentDiv1 = null;
    ...
    public DivAffiche(Form previous) {
        ...
        super.getToolbar().addMaterialCommandToLeftBar("  ", FontImage.MATERIAL_GAMES, e -> new TypeAffiche(this).show());
                super.getToolbar().addMaterialCommandToRightBar("  ", FontImage.MATERIAL_FAVORITE, e -> new LikeManipuler(this).show());
