...
public class EvenementManipuler extends Form {
    ...
    public EvenementManipuler(Form previous) {
        super(EvenementAffiche.currentEvenement == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentEvenement = EvenementAffiche.currentEvenement;
    ...
    private void showBackAndRefresh() {
        ((EvenementAffiche) previous).refresh();
        previous.showBack();
    }
